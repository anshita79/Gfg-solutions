<h2><a href="https://www.geeksforgeeks.org/problems/max-sum-subarray-of-size-k5313/1?_gl=1*1jwnm3e*_up*MQ..*_gs*MQ..&gclid=CjwKCAiA3-3KBhBiEiwA2x7FdNFz6m1DLH8gVfOz_Zht2tfX9EWULLaxOuzhuGJ9fyviuqY7Ub_e8hoCekcQAvD_BwE&gbraid=0AAAAAC9yBkBQn_rFhLE5uVvXdtusuTtF5">Max Sum Subarray of size K</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of integers<strong> arr[]&nbsp;</strong> and a number<strong> k</strong>. Return&nbsp;the <strong>maximum sum</strong> of a subarray of size <strong>k</strong>.</span></p>
